...
const fileUploaderDefaultImage = (
  <svg
    width='32'
    height='32'
    viewBox='0 0 32 32'
  ...
  >
    ...
    <defs>
      <pattern
        ...
        height='1'
      >
        <use xlinkHref='#image0_1441_50512' transform='scale(0.00195312)' />
      </pattern>
      <image
...
export class FileUploader {
  ...
  /**
   * renders Icon in FwFileUploader
   * @returns {JSX.Element}
   */
  renderFileUploaderIcon(): JSX.Element {
    return <img alt={this.icon} src={this.icon} height={50} width={48} />;
  }
